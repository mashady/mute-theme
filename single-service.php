...
<main id="primary" class="site-main">
    <?php if ( have_posts() ) : while ( have_posts() ) : the_post();
        ...
        // Fetch translations from correct meta keys
        $arabic_title   = get_post_meta(get_the_ID(), '_service_title_ar', true);
        $arabic_content = get_post_meta(get_the_ID(), '_service_content_ar', true);
    ...
    <article <?php post_class('service-post'); ?> dir="<?php echo esc_attr($dir); ?>">
        ...
        <section class="service-content max-w-4xl mx-auto px-4 py-10 <?php echo esc_attr($align); ?>">
        ...
        <section class="service-meta max-w-4xl mx-auto px-4 pb-8 <?php echo esc_attr($align); ?>">
            <?php
