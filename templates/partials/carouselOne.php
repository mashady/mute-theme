<div class="relative w-full h-screen overflow-hidden rounded-xl">
    ...
    <div id="slider" class="relative w-full h-full flex">
        <div class="slide min-w-full h-full flex-shrink-0 bg-green-900 relative flex items-end p-8 md:p-16"
            ...
            <div class="relative z-10 max-w-2xl">
                ...
                <div class="max-w-xl mx-auto px-4">
                    <p class="text-gray-200 mb-6 text-base sm:text-lg md:text-xl lg:text-2xl break-words
              overflow-hidden line-clamp-2 sm:line-clamp-none">
        ...
        <div class="slide min-w-full h-full flex-shrink-0 bg-emerald-800 relative flex items-end p-8 md:p-16"
