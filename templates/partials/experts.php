<section class="p-4 mb-[219px] sound-experts-section section-container">
    ...
    <div class="flex flex-col lg:flex-row gap-4 min-h-[536px] ">
        <div class="relative flex-1 flex flex-col justify-end items-start text-white rounded-[24px] p-6 min-h-[536px] lg:max-w-[600px] bg-cover bg-center bg-no-repeat main-card opacity-0 scale-95"
            ...
            <div class="relative z-10">
                <h1 class="text-white font-[Poppins] text-[32px] font-normal leading-[120%] mb-2">
        ...
        <div class="flex-1 flex flex-col gap-4">
            <div class="flex flex-col md:flex-row gap-4 w-full  h-full">
                <div
                    class="flex flex-col  justify-between items-end rounded-[24px] text-white p-6 bg-[#4B5D53] min-h-[256px] small-card opacity-0 ">
                    ...
                    <div class=" inline-flex flex-col justify-start items-start gap-[5px]">
                        <div class=" text-white text-3xl font-normal font-['Poppins'] leading-10">
                ...
                <div
                    class="flex flex-col justify-between items-end rounded-[24px] text-white p-6 bg-[#34413A] min-h-[256px] small-card opacity-0 ">
                    <div class="flex flex-row justify-between items-center gap-2 w-full">
            ...
            <div class="w-full mt-2">
                <div class="flex flex-row gap-3 w-full stats-row opacity-0 ">
