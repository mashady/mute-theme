...
<script>
        ...
        ready(function () {
            ...
            if (box) {
                ...
                function createOverlay() {
                    ...
                    ov.innerHTML = `<div class="w-[80%] max-w-[1200px] inline-flex justify-between items-center">
    <div class="inline-flex flex-col justify-start items-start gap-48">
        <div class=" flex flex-col justify-start items-start gap-4">
            <svg width="227" height="132" viewBox="0 0 227 132" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M1 26.9545V130.773L72.5909 104.818L154.409 130.773L226 104.818V1L154.409 26.9545L72.5909 1L1 26.9545Z"
                    fill="#EEEEEE" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M72.5911 1V104.818" stroke="#282828" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path d="M154.409 26.9546V130.773" stroke="#282828" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                <g clip-path="url(#clip0_2460_1961)">
                    <path
                        d="M45.2682 37.9507C46.0836 44.5071 36.8775 50.6227 36.8775 50.6227C36.8775 50.6227 26.2735 45.4988 25.4581 38.9424C25.18 36.7067 25.9569 34.5103 27.6179 32.8365C29.2788 31.1626 31.6877 30.1483 34.3147 30.0168C36.9417 29.8853 39.5716 30.6473 41.6257 32.1352C43.6799 33.6231 44.9901 35.715 45.2682 37.9507Z"
                        stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        d="M35.7125 41.2564C37.536 41.1651 38.8578 39.8331 38.6648 38.2812C38.4717 36.7293 36.8371 35.5453 35.0136 35.6366C33.1901 35.7279 31.8684 37.0599 32.0614 38.6118C32.2544 40.1636 33.8891 41.3477 35.7125 41.2564Z"
                        stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
                    <clipPath id="clip0_2460_1961">
                        <rect width="26.4466" height="22.6523" fill="white"
                            transform="matrix(0.998749 -0.0499985 0.123419 0.992355 20.9915 29.7413)" />
                    </clipPath>
                </defs>
            </svg>

            <div class="justify-start text-left"><span
                    class="text-Primary-Green-50 text-base font-bold  leading-relaxed">Building G53, Apartment
                    8</span><br><span class="text-Primary-Green-50 text-base font-light  leading-relaxed"> Gardnia
                    Street, Ahram Garden<br> Giza, Egypt</span></div>
        </div>
        <div class="w-48 inline-flex justify-between items-center">
            ...
            <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke="#F7F8F7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M8.00008 12.7727H2.66675V28.7727H8.00008V12.7727Z" stroke="#F7F8F7" stroke-width="2"
    ...
    <div class="w-[523px] inline-flex flex-col justify-start items-start gap-16">
        <div class="flex flex-col justify-center items-start">
            <div class=" flex flex-col justify-start items-start gap-7 overflow-hidden">
                <div class="justify-start text-Primary-Green-50 text-2xl font-normal font-['Poppins'] leading-7">Our
                ...
                <div class=" flex flex-col justify-center items-start gap-7">
                    <div class=" flex flex-col justify-start items-start gap-2.5">
                            ...
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                ...
                                <defs>
                                    <clipPath id="clip0_2460_2000">
                                        <rect width="24" height="24" fill="white" transform="translate(0 0.886353)" />
                                    </clipPath>
                                </defs>
                            </svg>
                        ...
                        <div class=" justify-start text-left text-Primary-Green-50 text-base font-light  leading-tight">
                            +20 112 605 2626</div>
                    </div>
                    <div class=" flex flex-col justify-start items-start gap-2.5">
        ...
        <div class=" flex flex-col justify-start items-start gap-2.5"> 
                <a
                    class="w-full px-6 py-3 bg-white rounded-3xl inline-flex justify-between items-center gap-2 overflow-hidden">
                    <div
                        class=" flex text-Primary-Green-700 text-2xl font-normal font-['Poppins'] leading-7">
                    ...
                    <div
                        ...
                        <svg width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.4262 11.376L23.0105 11.376L23.0105 19.9602" stroke="#34413A" stroke-width="2"
                                stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <a
                    class=" px-6 py-3 bg-white rounded-3xl inline-flex justify-start items-center gap-2 overflow-hidden">
                    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <div
                        class="flex-1 justify-start text-Primary-Green-700 text-2xl font-normal font-['Poppins'] leading-7">
                        Love use whatsapp let’s chat</div>
                    <div
                        class="p-1.5 rounded-[40px] outline outline-1 outline-offset-[-1px] outline-neutral-700 backdrop-blur-[20px] flex justify-start items-center">
                        <svg width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.4262 11.376L23.0105 11.376L23.0105 19.9602" stroke="#34413A" stroke-width="2"
