...
<div class="flex flex-col justify-center bg-green-950 hidden" id="box-overlay-template">
    <!-- Close X button -->
    <button class="lg:hidden absolute top-5 right-5 z-10 w-10 h-10 font-xl p-0 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 transition-colors duration-200" 
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        ready(function () {
            ...
            function createExpansionHandler(targetBox, triggerType = 'hover') {
                ...
                var originalParent = targetBox.parentNode;  // store original parent to prevent getting lost
                ...
                function expandBox() {
                    ...
                    gsap.to(originalChildren, { opacity: 0, duration: 0.12, stagger: 0.02 });
                    ...
                    expandTimeline.to(targetBox, { duration: 0.45, top: 0, left: 0, width: '100%', height: '100%' }, 0);
                    bgTween = gsap.to(targetBox, { duration: 0.3, backgroundColor: '#002019', ease: 'none' });
                ...
                function collapseBox() {
                    ...
                    if (expandTimeline) { expandTimeline.kill(); expandTimeline = null; }
                    state = 'collapsing';
                    ...
                    if (!placeholder) {
                        ...
                        if (originalChildren && originalChildren.length) {
                            gsap.to(originalChildren, { opacity: 1, duration: 0.12, stagger: 0.02 });
                        }
                ...
                return { expandBox: expandBox, collapseBox: collapseBox, getState: function() { return state; } };
            }
            ...
            if (box) {
                ...
                box.addEventListener('mouseleave', function (e) {
                    ...
                    setTimeout(function () {
                        ...
                        if (desktopHandler.getState() === 'expanding' || desktopHandler.getState() === 'expanded') {
                        ...
                        if (desktopHandler.getState() !== 'idle') desktopHandler.collapseBox();
                    }, 12);
                });
            }
                ...
                mobileBox.addEventListener('click', function (e) {
                    ...
                    if (!mobileIsExpanded) {
                        ...
                        setTimeout(function() {
                            ...
                            var closeBtn = mobileBox.querySelector('#overlay-close-btn');
                            if (closeBtn) {
                            ...
                            var closeButtons = mobileBox.querySelectorAll('a[href="/contact-us/"], a[href*="wa.me"]');
