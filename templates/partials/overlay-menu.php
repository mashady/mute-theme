...
<div id="overlayShell" class="fixed flex flex-col left-1/2 lg:right-4 -translate-x-1/2 bottom-0 lg:bottom-4 z-[9999] w-full lg:w-fit h-fit bg-Primary-Green-700 rounded-t-xl lg:rounded-xl shadow-lg justify-end m-auto">
